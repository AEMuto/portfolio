	...
	<div class="section__wrapper">
		<div class="section__column">
			...
			<p class="section__info">
				...
				donnant
				des instructions à un ordinateur, et le web est un terrain fantastique
		...
		<div class="section__column">
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg"
			     ...
			     viewBox="0 0 400 300" class="about__browser">
				<g class="drawing">
					<path
								fill="#F2F6F8"
				...
				<svg id="about__canvas" x="16.62" y="76.09" width="347.58"
				     height="209.47" viewBox="0 0 347.58 209.47">
					<rect x="0" y="0" width="100%" height="100%" fill="red"
					      stroke="#2C4751" stroke-width="2"/>
				</svg>
			</svg>
